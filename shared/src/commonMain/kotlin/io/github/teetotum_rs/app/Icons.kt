@file:Suppress("MaxLineLength") // Material Symbols path data does not break.
...
private fun symbol(name: String, path: String) = ImageVector.Builder(name, 24.dp, 24.dp, 960f, 960f)
...
val CloseIcon: ImageVector = symbol(
    "close",
    "m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z",
)

/** Material Symbol `home`: home. */
val HomeIcon: ImageVector = symbol(
    "home",
...
val AppearanceIcon: ImageVector = symbol(
    "visibility",
...
val ThemeIcon: ImageVector = symbol(
    "palette",
...
val HelpIcon: ImageVector = symbol(
    "help",
...
val ImprintIcon: ImageVector = symbol(
    "article",
...
val ChangelogIcon: ImageVector = symbol(
    "history",
...
val LibrariesIcon: ImageVector = symbol(
    "library_books",
...
val ExitIcon: ImageVector = symbol(
    "logout",
...
val GettingAroundIcon: ImageVector = symbol(
    "explore",
...
val ScanIcon: ImageVector = symbol(
    "qr_code_scanner",
    "M80-680v-200h200v80H160v120H80Zm0 600v-200h80v120h120v80H80Zm600 0v-80h120v-120h80v200H680Zm120-600v-120H680v-80h200v200h-80ZM700-260h60v60h-60v-60Zm0-120h60v60h-60v-60Zm-60 60h60v60h-60v-60Zm-60 60h60v60h-60v-60Zm-60-60h60v60h-60v-60Zm120-120h60v60h-60v-60Zm-60 60h60v60h-60v-60Zm-60-60h60v60h-60v-60Zm240-320v240H520v-240h240ZM440-440v240H200v-240h240Zm0-320v240H200v-240h240Zm-60 500v-120H260v120h120Zm0-320v-120H260v120h120Zm320 0v-120H580v120h120Z",
)

/** Material Symbol `sd_card`: the Help card on the card. */
val CardIcon: ImageVector = symbol(
    "sd_card",
    "M360-520h80v-160h-80v160Zm120 0h80v-160h-80v160Zm120 0h80v-160h-80v160ZM240-80q-33 0-56.5-23.5T160-160v-480l240-240h320q33 0 56.5 23.5T800-800v640q0 33-23.5 56.5T720-80H240Zm0-80h480v-640H434L240-606v446Zm0 0h480-480Z",
)

/** Material Symbol `share`: the Help card on sharing from other apps. */
val ShareIcon: ImageVector = symbol(
    "share",
...
val ProviderIcon: ImageVector = symbol(
    "badge",
...
val ContactIcon: ImageVector = symbol(
    "mail",
...
val CodeIcon: ImageVector = symbol(
    "code",
...
val LiabilityIcon: ImageVector = symbol(
    "gavel",
...
val LinkIcon: ImageVector = symbol(
    "link",
...
val DateIcon: ImageVector = symbol(
    "event",
    "M509-269q-29-29-29-71t29-71q29-29 71-29t71 29q29 29 29 71t-29 71q-29 29-71 29t-71-29ZM200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80H200Zm0-80h560v-400H200v400Zm0-480h560v-80H200v80Zm0 0v-80 80Z",
)

/** Material Symbol `photo_camera`: the Privacy card on the camera. */
val CameraIcon: ImageVector = symbol(
    "photo_camera",
...
val FolderIcon: ImageVector = symbol(
    "folder",
...
val ReleaseIcon: ImageVector = symbol(
    "new_releases",
...
val BluetoothIcon: ImageVector = symbol(
    "bluetooth",
